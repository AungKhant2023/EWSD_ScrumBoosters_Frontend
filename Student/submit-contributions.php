                                        ...
                                        <div class="review-content-section">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" placeholder="Give contribution a title">
                                                    </div>
                                            ...
                                            <div class="i-checks pull-left">
                                                ...
                                                <label for="checkboxTerms">Agree <a href="#" class="zoomInDown mg-t text-center" href="#" data-toggle="modal" data-target="#zoomInDown2">Terms and Conditions</a> </label>
                                            </div>

                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="login-horizental cancel-wp pull-left form-bc-ele">
                                                        <button type="submit" class="btn btn-custon-four btn-primary zoomInDown mg-t text-center">
                                                            <i class="fa fa-check edu-checked-pro" aria-hidden="true"></i>
                                                            <a class="zoomInDown mg-t text-center" href="#" data-toggle="modal" data-target="#zoomInDown1" style="color: white;">Please Sign In</a></button>
                                                                                                            ...
                                                                                                            <div class="col-lg-6 col-md-8 col-sm-10 col-xs-12">
                                                                                                                <form action="#">
                                                                                                                    <div class="login-btn-inner">
                                                                                                                        <div class="row">
                                                                                                                            <div class="col-lg-12 col-md-8 col-sm-8 col-xs-12 text-center">
                                                                                                                ...
                                                                                                                <form action="#">
                                                                                                                    <div class="login-btn-inner">
                                                                                                                        <div class="row">
                                                                                                                            <div class="col-lg-12 col-md-8 col-sm-8 col-xs-12 text-center">
                                                                                                                                <div class="login-horizental">
                                                                                                                                    <button class="btn btn-sm btn-primary login-submit-cs" type="submit">Terms and cConditions</button>
                                                                                                                                </div>
                                                                                                                            </div>
                                                                                                                        </div>
                                                                                                                    </div>
